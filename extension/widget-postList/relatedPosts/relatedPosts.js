$( document ).ready(function() {
  if(window.innerWidth > 991) {
    $.getJSON("posts.json", function( data2 ) {
      ...
      for(var i = 0; i < 3; ++i)
        $('#rp').append('<div class="item"> <div class="ui tiny image"> <img src="images/post'+data2.posts[i].url+'/item_'+data2.posts[i].thumb+'"> </div> <div class="middle aligned content"> <a class="header" href="'+data2.posts[i].url+'">'+data2.posts[i].title+'</a> </div> </div>');
